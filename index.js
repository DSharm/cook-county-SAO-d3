...
Promise.all([
  ...
  d3.json("processed_data/intake_year_status_race.json"),
  d3.json("processed_data/intake_year_race_gender.json"),
...
function makeVis(allData) {
  ...
  // nestGender.forEach(function (d) {
  //   d.values.forEach(function (d, m) {
  //     //console.log(nestRace[m].values[m].value);
  //     //console.log(d.value);
  //   });
    
  // });
  barChart(nested_data);
};
...
d3.json("processed_data/intake_year_race_gender.json")
        .then(function(data) {
            ...
            //console.log(nested_test_1);
            nested_test_1.forEach(function (a) {
              //console.log(a);
              a.values.forEach(function (a) {
                //console.log(a);
                if (!this[a.initiation_result] ) {
                  this[a.initiation_result] = {key: a.initiation_result, value: []}; 
                  nested_test.push(this[a.initiation_result]);
                }
